...
export default function NewPatientPage() {
  ...
  function validateContact() {
    ...
    if (phone && (phone.length < 10 || phone.length > 15)) return "Please enter a valid mobile number.";
    if (emergencyMobile && (emergencyMobile.length < 10 || emergencyMobile.length > 15)) return "Please enter a valid emergency mobile number.";
  ...
  function next(event?: FormEvent) {
    ...
    if (step === 2) setData((current) => ({ ...current, phone: current.phone.replace(/\D/g, ""), emergencyMobile: current.emergencyMobile.replace(/\D/g, "") }));

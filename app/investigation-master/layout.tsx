    ...
    <div className="investigation-premium-shell">
      <style jsx global>{`
        .investigation-premium-shell main {
          background:
            radial-gradient(circle at 8% 0%, rgba(11,99,206,.08), transparent 28%),
            radial-gradient(circle at 92% 8%, rgba(212,175,55,.08), transparent 24%),
            #f4f7fb !important;
          min-height:100vh;
        }
        ...
        .investigation-premium-shell main > div > header {
          min-height:78px;
          border-color:rgba(8,43,97,.10) !important;
          border-radius:24px !important;
          background:rgba(255,255,255,.94) !important;
          box-shadow:0 14px 38px rgba(8,43,97,.08) !important;
          backdrop-filter:blur(14px);
        }
        .investigation-premium-shell main > div > header h1 { font-size:1.35rem; letter-spacing:-.025em; }
        .investigation-premium-shell main > div > header button {
          border-radius:14px !important;
          box-shadow:0 8px 20px rgba(8,43,97,.16) !important;
        }
        .investigation-premium-shell main > div > section {
          border-radius:24px !important;
        }
        ...
        .investigation-premium-shell main > div > section:nth-of-type(n+2) {
          box-shadow:0 14px 38px rgba(8,43,97,.065) !important;
        }
        .investigation-premium-shell input,
        .investigation-premium-shell select {
          min-height:46px;
          border-radius:13px !important;
          transition:border-color .18s ease, box-shadow .18s ease, background .18s ease;
        }
        .investigation-premium-shell input:focus,
        .investigation-premium-shell select:focus {

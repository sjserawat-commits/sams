...
export default function SlipPrintSearchPage() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[linear-gradient(180deg,#f7efe2_0%,#fffaf2_45%,#eef5f3_100%)] text-slate-900">
      ...
      <div className="relative mx-auto max-w-[1280px] px-4 py-7 sm:px-7 lg:py-10">
        ...
        <section className="relative overflow-hidden rounded-[2rem] border border-white/80 bg-[linear-gradient(135deg,rgba(83,54,31,.97),rgba(166,111,52,.93),rgba(47,100,96,.94))] p-6 text-white shadow-[0_25px_75px_rgba(83,54,31,.22)] sm:p-8">
          ...
          <div className="relative max-w-3xl"><p className="text-[9px] font-black uppercase tracking-[.28em] text-amber-100">SAMS · Consultation Documentation</p><h1 className="mt-2 text-3xl font-black tracking-tight sm:text-5xl">Print Consultation Slip</h1><p className="mt-3 max-w-2xl text-sm leading-6 text-white/80">Find the patient, choose the required OPD visit, and generate a clean consultation slip for the front desk or clinical record.</p><div className="mt-6 flex flex-wrap gap-2"><span className="rounded-full border border-white/15 bg-white/10 px-3 py-1.5 text-[9px] font-black uppercase tracking-wide">Patient search</span><span className="rounded-full border border-white/15 bg-white/10 px-3 py-1.5 text-[9px] font-black uppercase tracking-wide">Visit selection</span><span className="rounded-full border border-white/15 bg-white/10 px-3 py-1.5 text-[9px] font-black uppercase tracking-wide">Print ready</span></div></div>
        </section>
        ...
        <section className="relative -mt-5 mx-2 rounded-[1.6rem] border border-white/80 bg-white/95 p-5 shadow-[0_20px_55px_rgba(37,58,63,.10)] backdrop-blur sm:mx-6 sm:p-6">
          <div><p className="text-[9px] font-black uppercase tracking-[.2em] text-teal-700">01 · Find Patient</p><h2 className="mt-1 text-xl font-black text-slate-800">Search Patient</h2><p className="mt-1 text-xs font-semibold text-slate-400">Search by patient name or HID.</p></div>

...
export default function Navigation({ variant = "default" }: NavigationProps) {
  ...
  const isPatientRegistry = pathname === "/patients";
    ...
    <nav className="sticky top-0 z-30 flex min-h-[76px] flex-wrap items-center gap-2 border-b border-[#d6a443]/20 bg-[linear-gradient(90deg,#061525_0%,#0a2138_55%,#071525_100%)] px-5 py-3 text-slate-200 shadow-[0_8px_28px_rgba(0,0,0,0.22)] sm:px-6">
      ...
      <div className="ml-auto flex flex-wrap items-center gap-1">
        {isPatientRegistry && <>
          ...
          <Link href="/patients/new" className="rounded-xl border border-[#d6a443]/70 bg-[#d6a443] px-3 py-2 text-xs font-black text-[#071525] transition hover:bg-[#f2d38b] sm:px-4">+ Patient Registration</Link>
        </>}
        {variant !== "reception" && !isPatientRegistry && <><Link href="/" className="rounded-xl border border-transparent px-3 py-2 text-xs font-black uppercase tracking-wide text-slate-300 transition hover:border-[#d6a443]/25 hover:bg-white/5 hover:text-[#f2d38b]">Home</Link><Link href="/dashboard" className="rounded-xl border border-transparent px-3 py-2 text-xs font-black uppercase tracking-wide text-slate-300 transition hover:border-[#d6a443]/25 hover:bg-white/5 hover:text-[#f2d38b]">Dashboard</Link></>}
        {variant !== "reception" && !isPatientRegistry && <><Link href="/patients" className="rounded-xl border border-transparent px-3 py-2 text-xs font-black uppercase tracking-wide text-slate-300 transition hover:border-[#d6a443]/25 hover:bg-white/5 hover:text-[#f2d38b]">Patients</Link><Link href="/clinical" className="rounded-xl border border-transparent px-3 py-2 text-xs font-black uppercase tracking-wide text-slate-300 transition hover:border-[#d6a443]/25 hover:bg-white/5 hover:text-[#f2d38b]">Clinical</Link><Link href="/billing" className="rounded-xl border border-transparent px-3 py-2 text-xs font-black uppercase tracking-wide text-slate-300 transition hover:border-[#d6a443]/25 hover:bg-white/5 hover:text-[#f2d38b]">Billing</Link><Link href="/reports" className="rounded-xl border border-transparent px-3 py-2 text-xs font-black uppercase tracking-wide text-slate-300 transition hover:border-[#d6a443]/25 hover:bg-white/5 hover:text-[#f2d38b]">Reports</Link><Link href="/admin" className="rounded-xl border border-[#d6a443]/25 bg-[#d6a443]/10 px-3 py-2 text-xs font-black uppercase tracking-wide text-[#f2d38b] transition hover:bg-[#d6a443]/20">Admin</Link><Link href="/portal" className="rounded-xl border border-[#d6a443]/25 bg-[#d6a443]/10 px-3 py-2 text-xs font-black uppercase tracking-wide text-[#f2d38b] transition hover:bg-[#d6a443]/20">Patient Portal</Link></>}
      </div>
    </nav>
  );
}

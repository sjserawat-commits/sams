...
export default function OPDSlipPrint(){
 ...
 return <main className="a4">
  <header className="head"><div className="brand"><img src="/serawat-logo.png" alt="S"/><div><div className="kicker">SAMS · OPD VISIT RECORD</div><div className="hospital">SERAWAT ADVANCED MUSCULOSKELETAL, JOINT &amp; SPINE CENTRE</div></div></div><div className="opd"><b>OPD · #{visit.tokenNumber}</b><span>{finalized?"FINALIZED VISIT":"VISIT REGISTRATION"}</span><strong>{dt(visit.createdAt)}</strong></div></header>

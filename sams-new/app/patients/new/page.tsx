...
export default function NewPatientPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    setError("");
    if (dateOfBirth && !parseManualDate(dateOfBirth)) {
    ...
    <main className="min-h-screen bg-[#f5f8fc] text-slate-900">
      ...
      <div className="mx-auto max-w-[1200px] px-5 py-7 sm:px-8 sm:py-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5"><p className="text-sm font-bold text-[#082b61]">Registration check</p><p className="mt-1 text-xs leading-5 text-slate-500">First name and last name are required. Date of birth is entered manually as DD/MM/YYYY and converted safely for the patient record.</p></div>

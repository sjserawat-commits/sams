...
const empty: RegistrationData = { firstName: "", lastName: "", dateOfBirth: "", gender: "", phone: "", aadhaarNumber: "", address: "", emergencyContact: "" };
...
export default function NewPatientPage() {
  ...
  function review(event: FormEvent<HTMLFormElement>) {
    ...
    setData((current) => ({ ...current, phone, aadhaarNumber: aadhaar }));
    setStep("review");
  }
  ...
  async function savePatient() {
    ...
    try {
      const response = await fetch("/api/patients", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ ...data, dateOfBirth: toApiDate(data.dateOfBirth) }) });

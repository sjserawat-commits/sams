...
import EncounterForm from "@/app/patients/profile/[id]/encounter/EncounterForm";
    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <div>
        ...
        <div className="mx-auto max-w-4xl px-6 py-8">
          <a href="/encounters" className="text-sm font-bold text-blue-700 hover:underline">← Back to Encounters</a>
          <div className="mt-5">
            ...
            <p className="mt-2 text-sm text-slate-500">{patient.firstName} {patient.lastName} · {patient.patientId}</p>
          </div>

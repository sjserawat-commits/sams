    ...
    <main className="min-h-screen bg-[#f4f7fb] px-5 py-7 text-slate-900 sm:px-8 lg:px-10">
      <div className="mx-auto max-w-[1180px]">
        <header className="mb-6 flex items-center justify-between rounded-[1.6rem] border border-slate-200 bg-white px-5 py-4 shadow-[0_12px_35px_rgba(8,43,97,0.06)] sm:px-7">
          ...
          <span className="hidden rounded-full border border-blue-100 bg-blue-50 px-3 py-1.5 text-[9px] font-black uppercase tracking-wider text-[#0b63ce] sm:inline-flex">Diagnostics</span>
        </header>
        ...
        <section className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#082b61] via-[#075dcc] to-[#0b63ce] p-7 text-white shadow-[0_25px_70px_rgba(8,43,97,0.18)] sm:p-10">
          ...
          <p className="relative mt-3 max-w-2xl text-sm leading-6 text-blue-100">The dedicated investigation workspace is now part of the SAMS navigation. Investigation ordering, results and reporting can be connected here without changing the patient visit workflow.</p>
        </section>

...
export default function HomeV2() {
  ...
  return (
    <main className="min-h-screen bg-[#f7f8fb] text-[#10233f]">
      ...
      <footer className="border-t border-slate-200 bg-white"><div className="mx-auto flex max-w-[1200px] flex-col gap-2 px-5 py-8 text-xs text-slate-400 sm:flex-row sm:justify-between"><span>SAMS • Serawat Advanced Musculoskeletal, Joint & Spine Centre</span><span>Clinical care • Pain medicine • Rehabilitation</span></div></footer>
    </main>
  );
}

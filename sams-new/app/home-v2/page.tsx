...
import SamsClinicalOverview from "@/components/SamsClinicalOverview";
    ...
    <div className="mx-auto max-w-[1500px] px-5 py-6 sm:px-8 sm:py-8">
      <section className="relative overflow-hidden rounded-[2.25rem] bg-[#082b61] px-6 py-8 text-white shadow-[0_25px_70px_rgba(8,43,97,0.20)] sm:px-10 sm:py-10 lg:px-12 lg:py-12">
        ...
        <div className="relative grid gap-10 lg:grid-cols-[1fr_330px] lg:items-end"><div>
          ...
          <h1 className="mt-6 max-w-4xl text-4xl font-black leading-[1.02] tracking-[-0.035em] sm:text-5xl lg:text-7xl">Advanced care,<br /><span className="text-blue-300">organized around you.</span></h1>
          <p className="mt-6 max-w-2xl text-sm leading-7 text-blue-100 sm:text-base">SAMS brings specialist clinical assessment, treatment planning and rehabilitation together across musculoskeletal, spine, neurological, paediatric and specialised care.</p>

...
const actions = [["New Patient", "Register and open a patient record", "/patients", "01"], ["New Encounter", "Start clinical documentation", "/encounters", "02"], ["Patients", "Search and manage patient records", "/patients", "03"], ["Reports", "Review operational intelligence", "/reports", "04"]];
    ...
    <div className="mx-auto max-w-[1500px] px-5 py-6 sm:px-8 sm:py-8">
      <section className="relative overflow-hidden rounded-[2.25rem] bg-[#082b61] px-6 py-8 text-white shadow-[0_25px_70px_rgba(8,43,97,0.20)] sm:px-10 sm:py-10 lg:px-12 lg:py-12">
        ...
        <div className="relative grid gap-10 lg:grid-cols-[1fr_330px] lg:items-end"><div>
          ...
          <p className="mt-6 max-w-2xl text-sm leading-7 text-blue-100 sm:text-base">A premium front door to patient care, encounters, rehabilitation, reporting and hospital operations at Serawat Advanced Musculoskeletal, Joint & Spine Centre.</p>
          <div className="mt-8 flex flex-wrap gap-3"><Link href="/patients" className="rounded-xl bg-white px-5 py-3 text-sm font-black text-[#082b61] shadow-xl transition hover:-translate-y-0.5 hover:bg-blue-50">New Patient <span className="ml-2">→</span></Link><Link href="/encounters" className="rounded-xl border border-white/20 bg-white/10 px-5 py-3 text-sm font-black text-white backdrop-blur transition hover:-translate-y-0.5 hover:bg-white/15">New Encounter <span className="ml-2">→</span></Link></div>

        ...
        <div className="mx-auto flex max-w-[1400px] items-center justify-between px-5 py-3 sm:px-8">
          <Link href="/" className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="max-w-[320px] text-[9px] font-bold uppercase tracking-[0.14em] text-slate-400">Serawat Advanced Musculoskeletal, Joint & Spine Centre</p>
            </div>
          </Link>
      ...
      <div className="mx-auto max-w-[1400px] px-5 py-7 sm:px-8 sm:py-10">
        <section className="relative overflow-hidden rounded-[2.5rem] bg-[#082b61] px-7 py-10 text-white shadow-[0_28px_80px_rgba(8,43,97,0.20)] sm:px-10 sm:py-14 lg:px-14">
          ...
          <div className="relative max-w-4xl">
            ...
            <p className="mt-6 max-w-3xl text-sm leading-7 text-blue-100 sm:text-base">Serawat Advanced Musculoskeletal, Joint & Spine Centre is focused on comprehensive physical medicine, rehabilitation and pain care—bringing clinical expertise together with a function-first approach to recovery.</p>
          </div>
        </section>
        ...
        <section className="mt-10 overflow-hidden rounded-[2.25rem] bg-white shadow-[0_18px_60px_rgba(8,43,97,0.06)] ring-1 ring-slate-200/70">
          <div className="grid lg:grid-cols-[1fr_auto] lg:items-center">
            <div className="p-7 sm:p-10"><p className="text-[10px] font-black uppercase tracking-[0.22em] text-[#0b63ce]">Serawat Advanced</p><h2 className="mt-2 text-2xl font-black tracking-tight">Restoring function • Relieving pain • Enhancing lives</h2><p className="mt-3 max-w-2xl text-sm leading-6 text-slate-500">Care at SAMS is built around clinical reasoning, personalized rehabilitation and measurable functional goals.</p></div>
        ...
        <footer className="mt-8 flex flex-col justify-between gap-2 border-t border-slate-200 pt-5 pb-8 text-xs font-medium text-slate-400 sm:flex-row"><span>SAMS • Serawat Advanced Musculoskeletal, Joint & Spine Centre</span><span>Physical Medicine • Rehabilitation • Pain Medicine • Electrodiagnosis</span></footer>
      </div>
    </main>
  );
}
